...
const Intro = () => {
  ...
  return (
    <div className="Intro w-[95%] h-auto rounded-lg lg:w-[60%] mx-auto my-2 bg-white p-4 flex flex-row border-solid border-3  border-[#cf3838] dark:border-0 dark:shadow-blue">
      <div className="introText w-full text-center">
        <h1 className="my-1 text-xl">Nick Leyland</h1>
        ...
        <img
          className="rounded-full h-[100px] w-[100px] lg:h-[175px] lg:w-[175px] mx-auto my-5"
          src="me.jpg"
          alt=""
        />
