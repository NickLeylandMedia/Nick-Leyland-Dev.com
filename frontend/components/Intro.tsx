...
const Intro = () => {
  ...
  return (
    <div className="Intro w-[95%] h-[300px] rounded-lg lg:w-[60%] mx-auto my-2 bg-white p-4 flex flex-row border-solid border-3  border-[#cf3838]">
      <div className="introText w-full text-center">
        <h1 className="my-1 text-xl">Hi! I'm Nick</h1>
        <h2 className="redText my-2">Fullstack Developer</h2>
        <img
